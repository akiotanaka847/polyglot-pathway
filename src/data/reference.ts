...
export const GRAMMAR_REF: Record<string, GrammarEntry[]> = {
  ...
  ru: [
    ...
    // === B1 ===
    { title: 'Предлоги + случай — Preposiciones', level: 'B1', category: 'sentence', explanation: 'в/на + Prep (ubicación), в/на + Acus (dirección). из/с + Gen (desde). к + Dat (hacia). о + Prep (sobre).', examples: [{ text: 'Я живу в Москве (Prep)', translation: 'Vivo en Moscú' }, { text: 'Я иду в школу (Acus)', translation: 'Voy a la escuela' }] },
